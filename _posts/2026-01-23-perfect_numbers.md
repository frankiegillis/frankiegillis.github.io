...
**Note:** Claims 2 and 3 can be used to write down a complete characterisation of $\sigma$ based on the prime factorisation of $a \in \mathbb{N}$. If $a = p_1 ^{\alpha_1} \cdots p_k^{\alpha_k}$, then 
