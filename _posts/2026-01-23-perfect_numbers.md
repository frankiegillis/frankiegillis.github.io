...
**Note:** Claims 2 and 3 can be used to write down a complete characterisation of $\sigma(a)$ depending on the prime factorisation of $a$: if $a = p_1 ^{\alpha_1} \cdots p_k^{\alpha_k}$, then 
